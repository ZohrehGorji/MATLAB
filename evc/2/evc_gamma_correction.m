...
%   brightness...   brightness of the image
    ...
    %HINT: 	The function 'rgb2gray' might be useful.    
     maximum = max(input(:));
     normalized =input.*(1/maximum);
     grayImage = rgb2gray(normalized);
     brightness = grayImage.* maximum;
end
...
%   chromaticity...     chromaticity of the image
	...
	%TODO:  Implement this function.
        ...
        brightnessAlle3 = repmat(brightness, [1 1 3]);
        
        chromaticity = input./brightnessAlle3;
